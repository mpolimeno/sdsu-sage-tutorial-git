...
intersphinx_mapping = {'python': ('http://docs.python.org/2.7', None), 'sage': ('http://www.sagemath.org/doc/reference',None)}
...
latex_preamble = '\usepackage{amsmath,amssymb,amsthm}'
